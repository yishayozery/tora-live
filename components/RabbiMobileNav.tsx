...
import { Menu, X, Archive, LayoutDashboard, MessageSquare, Settings, LogOut, Radio, Plus, Users, Megaphone, Share2 } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/share-kit", icon: Share2, label: "ערכת שיתוף" },
