...
export const metadata = {
  title: "הצטרפות רבנים | TANA",
  description:
    "TANA היא הבית הדיגיטלי של רבני ישראל. דף משלך, לוח שיעורים, שידור חי, ופניות מסודרות מתלמידים — בחינם. הצטרף בכמה דקות.",
  openGraph: {
    title: "הצטרפות רבנים | TANA",
    description:
      "דף רב משלך, לוח שיעורים, שידור חי, פניות מסודרות מתלמידים — בחינם. הצטרף לקהילת הרבנים של TANA.",
    type: "website",
    locale: "he_IL",
  },
};
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 lg:py-32 text-center">
          ...
          <p className="mt-6 text-base sm:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
            TANA היא הבית הדיגיטלי של רבני ישראל. דף משלך, לוח שיעורים,
